...
ngUploader is a file uploader based on angularjs and bootstrap

  - Upload multiple files
  - Allows concurrent Upload
  - Totally cutomizable

ngUploader is a multi file uploader you can use with JQuery or every library or framework:
